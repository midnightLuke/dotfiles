---
name: resolve-issue
description: Systematically resolve a GitHub issue with a structured workflow — research, plan, implement, verify, and report. Use when asked to fix or resolve a GitHub issue.
