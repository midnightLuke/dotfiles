---
name: merge-pr
description: Merge a pull request with consistent practices — verify checks, squash merge, clean up the branch, and pull latest main. Use when asked to merge a PR.
