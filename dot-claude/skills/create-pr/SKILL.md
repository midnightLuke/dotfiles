---
name: create-pr
description: Create a pull request from the current branch with proper formatting and issue linking. Use when asked to open or create a PR.
argument-hint: [--issue N] [--draft] [--skip-issue-link]
user-invocable: true
allowed-tools: Bash
---
