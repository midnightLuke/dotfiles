---
name: review-pr
description: Review a GitHub pull request and report findings by severity. Read-only — does not make changes. Use when asked to review a PR.
argument-hint: [pr-number] [--quick|--thorough|--security]
user-invocable: true
allowed-tools: Bash
---
